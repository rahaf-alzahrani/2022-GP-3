...
class SGAlert extends StatefulWidget {
  const SGAlert({super.key});

  @override
  State<SGAlert> createState() => _AdminAlertPageState();
}

class _AdminAlertPageState extends State<SGAlert> {
  @override
