...
class AdminNotificationPage extends StatefulWidget {
  ...
  @override
  State<AdminNotificationPage> createState() => _AdminAlertPageState();
}

class _AdminAlertPageState extends State<AdminNotificationPage> {
  @override
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: ((context, index) {
                        ...
                        AdminAlertPage.newTimestamp = DateFormat("DD/MM/yyyy").format(notification.time);
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              DateFormat("dd-MM-yyyy hh:mm aa").format(notification.time),
                                      ...
                                      CircleAvatar(
                                        backgroundColor: _getColor(notification.newStatus),
                                        child: Icon(
  ...
  Stream<List<UserNotification>> notificationStream() {
    return FirebaseFirestore.instance.collection("notification")
